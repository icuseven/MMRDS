function navigation_render(p_metadata, p_level, p_ui)
{
   ...
   switch(p_metadata.type.toLowerCase())
   {
     ...
     case 'app':
        ...
        if(parseInt(p_ui.url_state.path_array[0]) >= 0)
        {
          result.push('<li><a href="print-version" target="_print-version">print version</a></li>');
          result.push('<li><a href="print-version" target="_print-version">print core summary</a></li>');
        }
        result.push('<li><a href="data-dictionary" target="_data-dictionary">show data dictionary</a></li>');
