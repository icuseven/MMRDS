...
namespace mmria.server
{
	public class DriveSettings
	{
		...
		public static void MapNetworkDrive(string sDriveLetter, string sNetworkPath, string pUserName = null, string pPassword = null)
		{
			...
			WNetAddConnection2(ref oNetworkResource, pPassword, pUserName, 0);
		}
