...
public sealed class v2_6_2_Migration
{
    ...
    {
        this.output_builder.AppendLine($"v2.6.2 Data Migration started at: {DateTime.Now.ToString("o")}");
        DateTime begin_time = System.DateTime.Now;
        
        this.output_builder.AppendLine($"v2_6_2_Migration started at: {begin_time.ToString("o")}");
...
/*
            ...
            foreach(var case_item in case_response.rows)
            {
                ...
                {
                    var save_result = await new SaveRecord(this.host_db_url, this.db_name, this.config_timer_user_name, this.config_timer_value, this.output_builder).save_case(doc as IDictionary<string, object>,"v2.6.2 part1");
                }
    ...
    Console.WriteLine($"v2_6_2_Migration Finished {DateTime.Now}");
}
