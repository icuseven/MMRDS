...
namespace mmria.server.Controllers
{
    ...
    public class ecpaasTestController : Controller
    {
        IConfiguration configuration;

        mmria.common.couchdb.ConfigurationSet ConfigDB;

        public ecpaasTestController(IConfiguration p_configuration, mmria.common.couchdb.ConfigurationSet p_config_db)
        {
        ...
        public async Task<IActionResult> Index(System.Threading.CancellationToken cancellationToken)
        {
            ...
            var file_name = "ms_test.csv";

            var output_path = System.IO.Path.Combine (configuration["mmria_settings:export_directory"], file_name);
/*
            if(output_path.StartsWith("/home/net_core_user/app/workdir/mmria-export"))
            {
            ...
            */
            ...
            mmria.server.utils.WriteCSV writer = new mmria.server.utils.WriteCSV(file_name, "", configuration["mmria_settings:export_directory"]);
            DataTable table = writer.Table;
            DataColumn column;
            DataRow row;
            ...
            byte[] fileBytes = GetFile(output_path);
            return File(fileBytes, "application/octet-stream", file_name);
        }
