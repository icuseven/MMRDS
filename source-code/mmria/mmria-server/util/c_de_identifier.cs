...
namespace mmria.server.util
{
	public class c_de_identifier
	{
		...
		static HashSet<string> de_identified_set = new HashSet<string>(){
			...
			"death_certificate/place_of_last_residence/feature_matching_geography_type",
			"death_certificate/place_of_last_residence/naaccr_gis_coordinate_quality_code",
			"death_certificate/place_of_last_residence/naaccr_gis_coordinate_quality_type",
			"death_certificate/place_of_last_residence/naaccr_census_tract_certainty_code",
			"death_certificate/place_of_last_residence/naaccr_census_tract_certainty_type",
			"death_certificate/place_of_last_residence/state_county_fips",
			"death_certificate/place_of_last_residence/census_state_fips",
			"death_certificate/place_of_last_residence/census_county_fips",
			"death_certificate/place_of_last_residence/census_tract_fips",
			"death_certificate/place_of_last_residence/urban_status",
			"death_certificate/place_of_last_residence/census_met_div_fips",
			"death_certificate/place_of_last_residence/census_cbsa_fips",
			"death_certificate/place_of_last_residence/census_cbsa_micro",
