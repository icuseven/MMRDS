<%@ taglib uri="//java.sun.com/jsp/jstl/core" prefix="c" %><script>if (typeof page_timing !== 'undefined') { page_timing.modules_start = Date.now(); }</script>
...
<script>if (typeof page_timing !== 'undefined') { page_timing.modules_end = Date.now(); }</script>
