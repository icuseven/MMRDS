<%@ taglib uri="//java.sun.com/jsp/jstl/core" prefix="c" %><script>if (typeof page_timing !== 'undefined') { page_timing.core_start = Date.now(); }</script>
...
<script src="/TemplatePackage/3.0/js/libs/moment/moment.min.js"></script>
...
<script>if (typeof page_timing !== 'undefined') { page_timing.core_end = Date.now(); }</script>
