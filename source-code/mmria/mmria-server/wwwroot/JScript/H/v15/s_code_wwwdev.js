...
s.linkInternalFilters="javascript:,cdc,file:///,outbind,//www/,mid://,//cisat.isciii.es/mmwr/,//iier.isciii.es/mmwr/,//iier1.isciii.es/atsdr/,//cisat1.isciii.es/atsdr/,bam.gov,5aday.gov,fruitsandveggiesmatter.gov,millionhearts.hhs.gov,hivtest.org";
...
function s_doPlugins(s) {
	/* Add calls to plugins here */
		...
		var ds=["bam.gov","cdc.gov","5aday.gov","hivtest.org","mid://","http://198.246.96.2","outbind:"];
...
+"s.fun,'_','-'),imn='s_i_'+s.fun,im,b,e,rs='https://cdc.112.2o7.net/b/ss/'+s.un+'/1/H.6-pdv-"
