...
<div align=center>${await render2_chart(p_post_html, metadata, data_list)}</div>
<br/>
<div align=center>${await render2_table(metadata, data_list)}</div>
</div>
...
async function render2_chart(p_post_html, p_metadata, p_data_list)
{
...
async function render2_table(p_metadata, p_data_list)
{
    const totals = new Map();
