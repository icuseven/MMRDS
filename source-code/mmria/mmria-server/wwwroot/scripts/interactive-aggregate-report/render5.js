async function render5(p_post_html)
{
    const metadata = indicator_map.get(5);
...
<br/>
<div align=center>${await render5_table(metadata, data_list)}</div>
</div>
...
async function render5_chart(p_post_html, p_metadata, p_data_list)
{
...
async function render5_table(p_metadata, p_data_list)
{
    const totals = new Map();
