function app_render(p_result, p_metadata, p_data, p_ui, p_metadata_path, p_object_path, p_dictionary_path, p_is_grid_context, p_post_html_render, p_search_ctx, p_ctx) 
{
    ...
    {
        p_result.push("<h1 class='content-intro-title h2' tabindex='-1'>CDC Analyst Line Listing Summary</h1>");
    }
    else
    {
        p_result.push("<h1 class='content-intro-title h2' tabindex='-1'>CDC Abstractor Line Listing Summary</h1>");
    }
...
*/
        ...
        else
        {
            ...
            attachment_render(p_result, p_metadata, p_data, p_ui, p_metadata_path, p_object_path, p_dictionary_path, p_is_grid_context, p_post_html_render, p_search_ctx, p_ctx)
