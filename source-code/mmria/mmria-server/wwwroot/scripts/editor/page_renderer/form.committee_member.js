                                ...
                                <p>
                                    ${
                                        ...
                                        (notes.reviewer_note != null &&
                                            ...
                                            : textarea_control_replace_return_with_br(
                                                    notes.reviewer_note
                                                )
                                    }
                                </p>
                            ...
                            p_result.push(`
                                <li>
                                    <p class="mb-2 font-weight-bold">
                                        ...
                                        ${
                                            !isNullOrUndefined(visitType) && visitType !== "(blank)"
                                                ? `– ${visitType}`
                                                : ""
                                        }
                                        ${
                                            !isNullOrUndefined(providerType) && providerType !== "(blank)"
                                                ? `– ${providerType}`
                                                : ""
                                        }
                                        ${
                                            !isNullOrUndefined(pregnancyStatus) && pregnancyStatus !== "(blank)"
                                                ? `– ${pregnancyStatus}`
                                                : ""
                                        }
                                    </p>
                                ...
                                p_result.push(`
                                    <li>
                                        <p class="mb-2 font-weight-bold">
                                            ...
                                            ${
                                                !isNullOrUndefined(interviewType) && interviewType !== "(blank)"
                                                    ? `– ${interviewType}`
                                                    : ""
                                            }
                                            ${
...
function render_print_form_control(p_result, p_ui, p_metadata, p_data) {
	if (parseInt(p_ui.url_state.path_array[0]) >= 0) {
		...
		p_result.push(`<input type="button" id="print-case-form" class="btn btn-primary ml-3" value="Print Record(s)" onclick="print_case_onclick(event)" disabled="true" />`);
