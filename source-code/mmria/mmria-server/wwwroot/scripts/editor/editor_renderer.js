  ...
  switch (p_metadata.type.toLowerCase()) {
    ...
    case 'form':
      ...
      if (p_metadata.type.toLowerCase() != 'form') {
        result.push(
          '<input type="button" value="c"  onclick="editor_set_copy_clip_board(this,\'' +
            p_path +
            '\')" /> '
        );
      }
      result.push(
        '<input type="button" value="d" onclick="editor_delete_node(this,\'' +
          p_path +
          '\')"/> '
      );
      ...
      result.push(
        ' <input type="button" value="ps" onclick="editor_paste_to_children(\'' +
          p_path +
          '\', true)" />'
      );
      result.push(
        ' <input type="button" value="kp" onclick="editor_cut_to_children(\'' +
          p_path +
          '\', true)" />'
      );
      ...
      result.push(p_path);
      result.push(
        '/children"><input type="button" value="-" onclick="editor_toggle(this, g_ui)"/> children:'
      );
      ...
      result.push(
        ' <input type="button" value="add" onclick="editor_add_to_children(this, g_ui)" path="'
      );
      result.push(p_path);
      result.push('" />');
      result.push(
        ' <input type="button" value="p" onclick="editor_paste_to_children(\'' +
          p_path +
          '\')" /> '
      );
      result.push(
        ' <input type="button" value="k" onclick="editor_cut_to_children(\'' +
          p_path +
          '\')" /> '
      );
    ...
    case 'app':
      ...
      if (p_metadata.lookup) {
        ...
        result.push(
          '"><input type="button" value="-" onclick="editor_toggle(this, g_ui)" /> lookup: <input type="button" value="add list" onclick="editor_add_list(this)"/> '
        );
      ...
      result.push(p_path + '/children');
      result.push(
        '"><input type="button" value="-" onclick="editor_toggle(this, g_ui)" /> children: <input type="button" value="add" onclick="editor_add_form(this)"/> '
      );
      //result.push(p_path + "/children");
      result.push('<ul>');
    ...
    case 'jurisdiction':
      ...
      result.push(
        '<input type="button" value="^" onclick="editor_move_up(this, g_ui)"/> <input type="button" value="c" onclick="editor_set_copy_clip_board(this,\'' +
          p_path +
          '\')" /> '
      );
      result.push(
      ...
      if (
        ...
        result.push(
          ' <input type="button" value="upgrade to 500 limit" onclick="editor_add_500Limit(\'' +
            p_path +
      ...
      if (
        ...
        result.push(
          ' <input type="button" value="upgrade to 32K limit" onclick="editor_add_30K(\'' +
            p_path +
    ...
    case 'list':
      ...
      result.push(
        ' <input type="button" value="add" onclick="editor_add_value(\'' +
          p_path +
          '/' +
          'values' +
          '\')" /> '
      ...
      for (
        let list_iterator = 0;
        list_iterator < p_metadata.values.length;
        list_iterator++
      ) {
      ...
      if (is_conversion_needed) {
        result.push(
          ' <input type="button" value="upgrade to numeric/display" onclick="editor_upgrade_numeric_and_display(\'' +
            p_path +
            '/' +
            'values' +
      ...
      for (var i = 0; i < p_metadata.values.length; i++) {
        ...
        result.push(
          '"> <input type="button" value="^" onclick="editor_move_up(this, g_ui)"/> <input type="button" value="d" onclick="editor_delete_value(this,\'' +
            p_path +
            '/' +
            'values/' +
            i +
