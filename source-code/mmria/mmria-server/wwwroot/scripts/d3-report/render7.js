...
<div align=center>${await render7_chart(p_post_html)}</div>
<div align=center>${await render7_table()}</div>
</div>
...
async function render7_chart(p_post_html)
{
