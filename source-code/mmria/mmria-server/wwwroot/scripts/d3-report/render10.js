...
<div align=center>${await render10_chart(p_post_html)}</div>
<div align=center>${await render10_table()}</div>
</div>
...
async function render10_chart(p_post_html)
{
