...
<div align=center>${await render9_chart(p_post_html)}</div>
<br/>
<div align=center>${await render9_table()}</div>
</div>
...
async function render9_chart(p_post_html)
{
