...
<br/>
<div align=center>${await render6_table(metadata, data_list)}</div>
</div>
...
async function render6_chart(p_post_html, p_metadata, p_data_list)
{
...
async function render6_table(p_metadata, p_data_list)
{
    const totals = new Map();
