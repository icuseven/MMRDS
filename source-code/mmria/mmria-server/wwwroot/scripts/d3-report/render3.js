...
<div">
<div align=center>${await render3_chart(p_post_html)}</div>
<div align=center>${await render3_table()}</div>
</div>
...
async function render3_chart(p_post_html)
{
