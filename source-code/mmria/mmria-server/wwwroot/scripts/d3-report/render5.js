...
<div">
<div align=center>${await render5_chart(p_post_html)}</div>
<div align=center>${await render5_table()}</div>
</div>
...
async function render5_chart(p_post_html)
{
