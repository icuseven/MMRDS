...
async function aggregate_pdf(report_index)
{
    ...
    let description = indicator_map.get(report_index).description;
    let headers = {
...
function dqr_detail(ctx) {
	...
	{
		body = format_detail_no_data(ctx);		
...
function format_detail_no_data(ctx) {
	let retPage = [];
	let rows = new Array();
    let description = indicator_map.get(ctx.index).description;
...
// ************************************************************************
//
// End - Build the record based on what kind it is
//
// ************************************************************************
// ************************************************************************