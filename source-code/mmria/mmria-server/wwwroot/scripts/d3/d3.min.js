!function () {
	...
	function Ju(n, t, e) {
		...
		if (n.point) {
			n.leaf || (n.point.x += $mmria.getRandomCryptoValue() - .5, n.point.y += $mmria.getRandomCryptoValue() - .5);
	...
	function na(n) {
		...
		t.createContextualFragment(escape(n.responseText))
	}
	var ta = {
		version: "3.5.6"
	},
	...
	ta.shuffle = function (n, t, e) {
		...
		for (var r, u, i = e - t; i; )
			u = $mmria.getRandomCryptoValue() * i-- | 0, r = n[i + t], n[i + t] = n[u + t], n[u + t] = r;
		return n
	},
		...
		a.start = function () {
			function n(n, r) {
				...
				for (var i, o = e[t], a = -1, l = o.length; ++a < l; )
					if (!isNaN(i = o[a][n]))
						return i;
				return $mmria.getRandomCryptoValue() * r
			}
			var t,
			e,
			r,
	...
	ta.random = {
		normal: function (n, t) {
			...
			function () {
				...
				u;
				do
					e = 2 * $mmria.getRandomCryptoValue() - 1, r = 2 * $mmria.getRandomCryptoValue() - 1, u = e * e + r * r;
				while (!u || u > 1);
