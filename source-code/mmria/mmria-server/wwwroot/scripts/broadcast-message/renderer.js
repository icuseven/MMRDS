function render()
{
    ...
    (
        ...
        <form class="w-75 flex-column pl-1 pr-4" id="message-one-form">
            <div>
                <h2 class="h3" id="message-one-header">Message 1 (<i>${message_one.publish_status == 0 ? 'Unpublished' : 'Published'}</i>)</h2>            
            </div>
            <div>
        ...
        <form class="w-75 flex-column pl-1 pr-4" id="message-two-form">
            <div>
                <h2 class="h3" id="message-two-header">Message 2 (<i>${message_two.publish_status == 0 ? 'Unpublished' : 'Published'}</i>)</h2>
            </div>
            <div>
