...
namespace mmria.services.util
{
	public class c_sync_document
	{
		...
		public async System.Threading.Tasks.Task executeAsync()
		{
			...
			{
				de_identified_json = await new mmria.services.util.c_de_identifier(document_json).executeAsync();
			...
			try
			{
				string aggregate_json = new mmria.services.util.c_convert_to_report_object(document_json).execute();
			...
			try
			{
				string opioid_report_json = new mmria.services.util.c_convert_to_opioid_report_object(document_json).execute();
