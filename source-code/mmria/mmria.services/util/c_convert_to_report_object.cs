...
";
		...
		public string execute ()
		{
			...
			mmria.services.model.c_report_object report_object;
			...
			report_object = new mmria.services.model.c_report_object ();
...
*/
		...
		private void popluate_pregnancy_deaths_by_pregnant_at_time_of_death(ref mmria.services.model.c_report_object p_report_object, System.Dynamic.ExpandoObject p_source_object)
		{
...
private void popluate_pregnancy_deaths_by_age (ref mmria.services.model.c_report_object p_report_object, System.Dynamic.ExpandoObject p_source_object)
{
...
*/
		...
		private void popluate_total_number_of_pregnancy_related_deaths_by_ethnicity (ref mmria.services.model.c_report_object p_report_object, System.Dynamic.ExpandoObject p_source_object)
		{
			if (p_report_object.total_number_of_cases_by_pregnancy_relatedness.pregnancy_related == 1)
			{
		...
		private void popluate_total_number_of_pregnancy_associated_deaths_by_ethnicity (ref mmria.services.model.c_report_object p_report_object, System.Dynamic.ExpandoObject p_source_object)
		{
		...
		private void popluate_total_number_of_cases_by_pregnancy_relatedness (ref mmria.services.model.c_report_object p_report_object, System.Dynamic.ExpandoObject p_source_object)
		{
		...
		private void popluate_list (ref System.Collections.Generic.Dictionary<string, int> p_result, ref mmria.services.model.c_report_object p_report_object, System.Dynamic.ExpandoObject p_source_object, string p_mmria_path, bool p_is_pregnance_related)
        {
