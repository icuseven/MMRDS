...
namespace mmria.services.util
{
  public class core_element_exporter
  {
    ...
    public core_element_exporter(mmria.services.model.actor.ScheduleInfoMessage configuration)
    {
      this.Configuration = configuration;
      //this.is_offline_mode = bool.Parse(Configuration["mmria_settings:is_offline_mode"]);

    }
    public void Execute(mmria.services.export_queue_item queue_item)
    {
