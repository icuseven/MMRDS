...
namespace getset
{
    public class create_default_object
    {
        /*
        static public System.Dynamic.ExpandoObject create_default_object(mmria.common.metadata.node p_metadata, mmria.common.metadata.node p_parent, bool p_create_grid)
        {
