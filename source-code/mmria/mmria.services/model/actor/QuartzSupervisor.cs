...
using System.Linq;
using Akka.Actor;
using mmria.services.model.actor.quartz;
        ...
        protected override void OnReceive(object message)
        {
            ...
            switch (message)
            {
                ...
                case "pulse":
                    ...
                    mmria.services.model.actor.ScheduleInfoMessage new_scheduleInfo = new actor.ScheduleInfoMessage
						(
        ...
        protected override void OnReceive(object message)
        {
            ...
            switch (message)
            {
                case WriteFile file:
                    ...
                    IJobDetail check_for_changes_job = JobBuilder.Create<mmria.services.model.check_for_changes_job> ()
                    ...
                    IJobDetail rebuild_queue_job = JobBuilder.Create<mmria.services.model.rebuild_queue_job> ()
