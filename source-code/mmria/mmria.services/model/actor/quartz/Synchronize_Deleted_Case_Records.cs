    ...
    public class Synchronize_Deleted_Case_Records : UntypedActor
    {
        ...
        protected override void OnReceive(object message)
        {
            ...
            switch (message)
            {
                ...
                mmria.services.model.couchdb.c_change_result latest_change_set = GetJobInfo(Program.Last_Change_Sequence, scheduleInfo);
        ...
        public mmria.services.model.couchdb.c_change_result GetJobInfo(string p_last_sequence, ScheduleInfoMessage p_scheduleInfo)
        {
