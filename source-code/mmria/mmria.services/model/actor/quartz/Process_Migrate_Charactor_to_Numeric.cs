        ...
        protected override void OnReceive(object message)
        {
			switch (message)
			{
				case Process_Initial_Migrations_Message process_initial_migrations_message:
                    ...
                    var Process_Initial_Migrations_Message = new mmria.services.model.actor.quartz.Process_Initial_Migrations_Message
                    (
                        DateTime.Now
                    );

                    Context.ActorOf(Props.Create<mmria.services.model.actor.quartz.Process_Migrate_Data>()).Tell(Process_Initial_Migrations_Message);
