...
*/
            ...
            try
            {
                ...
                var session_message_curl = new mmria.pmss.server.cURL("GET", null, request_string, null, db_config.user_name, db_config.user_value);
            ...
            )
            {
                ...
                {   
                    ...
                    try
                    {
                        ...
                        var session_put_curl = new mmria.pmss.server.cURL("PUT", null, request_string, session_message_json, db_config.user_name, db_config.user_value);
