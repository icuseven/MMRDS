...
public class Template_Writer_SG_Get
{
    Dictionary<string, mmria.common.metadata.Metadata_Node> dictionary_set;
    string name_space = string.Empty;
    public Template_Writer_SG_Get(Dictionary<string, mmria.common.metadata.Metadata_Node> _dictionary_set, string p_namespace)
    {
    ...
    {
        var get_set_template = System.IO.File.ReadAllText("mmria_case.get.sg.template.cs.text").Replace(".v241001;",$".{name_space};");
        ...
        System.IO.File.WriteAllText("output/mmria_case.get.sg.cs", get_set_template);
    }
