...
public class Template_Writer_MG_Get
{
    ...
    public Template_Writer_MG_Get(Dictionary<string, mmria.common.metadata.Metadata_Node> _dictionary_set, string p_namespace)
    {
    ...
    {
        var get_set_template = System.IO.File.ReadAllText("mmria_case.get.mg.template.cs.text").Replace(".v241001;",$".{name_space};");
        ...
        System.IO.File.WriteAllText("output/mmria_case.get.mg.cs", get_set_template);
    }
