...
public class Template_Writer_MG_Set
{
    Dictionary<string, mmria.common.metadata.Metadata_Node> dictionary_set;
    string name_space = string.Empty;
    public Template_Writer_MG_Set(Dictionary<string, mmria.common.metadata.Metadata_Node> _dictionary_set, string p_namespace)
    {
    ...
    {
        var get_set_template = System.IO.File.ReadAllText("mmria_case.set.mg.template.cs.text").Replace(".v241001;",$".{name_space};");
